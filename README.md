...
1. Pastikan terpasang PHP versi 8.0 atau yang lebih baru di komputer.
2. Clone repository ini:
   ```bash
   git clone [https://github.com/gwenogia2/php-oop-basics.git](https://github.com/gwenogia2/php-oop-basics.git)